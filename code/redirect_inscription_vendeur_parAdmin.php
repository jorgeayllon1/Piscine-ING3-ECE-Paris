    ...
    if (isset($_POST["ajout_vendeur"])) {
        ...
        if ($db_found) {
            ...
            if (mysqli_num_rows($result) == 0) {
                ...
                $info_client["prenom"] = $_POST["prenom_admin_inscription"];
                $info_client["nom"] = $_POST["nom_admin_inscription"];
                $info_client["pseudo"] = $_POST["pseudo_admin_inscription"];
                $info_client["email"] = $mail;
                $info_client["rang"] = 2;
                $info_client["mdp"] = $_POST["mdp_admin_inscription"];
                $info_client["image"] = $_POST["vendeur_pdp"];
                $info_client["image_back"] = $_POST["vendeur_background"];
                ...
                $_SESSION["pseudo"] = $info_client['pseudo'];
                $_SESSION["photo_perso"] = $info_client["image"];
                $_SESSION["photo_background"] = $info_client["image_back"];
