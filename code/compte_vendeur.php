			...
			<div class="row d-flex justify-content-center ">
				<div class="col-lg-2 " >
					<aside class="col-12 col-md-2 p-0  "  >
							...
							<ul class="nav" >
								<li class="nav-item ">
									<a class="nav-link active" style="background-color: #E52714;"  data-toggle="tab"
									 href="#info-vendeur" role="tab"  aria-selected="true">Mes informations</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" style="background-color: #E52714;height: 80px; width: 120px;"  data-toggle="tab" 
									href="#historique-vendeur" role="tab" aria-selected="false">Historique des ventes</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" style="background-color: #E52714;height: 80px; width: 120px;"  data-toggle="tab" 
									href="#publier-vendeur" role="tab" aria-selected="false">Publier une vente</a>
								</li>

								<li class="nav-item ">
									<a class="nav-link " style="background-color: #E52714; height: 80px; width: 120px;"  data-toggle="tab" 
									href="#retirer-vendeur" role="tab" aria-selected="false">Retirer une vente</a>
								</li>

								<li class="nav-item">
									<a class="nav-link " style="background-color: #E52714;height: 80px; width: 120px;"  data-toggle="tab" 
									href="#nego-vendeur" role="tab" aria-selected="false">Mes négociations</a>
								</li>
							</ul>
					...
					<div class="tab-content">
						...
						<div class="tab-pane fade show active " id="info-vendeur" >
							<form class="text-center border border-light " action="#!"> <!--PHP-->
								...
								<button class="btn my-4 nav-vendeur" style="background: #E52714; border:none; color:#fff;" 
