<!DOCTYPE html> <!--FICHIER TEST-->
	...
	<body>
        ...
        <div class="container my-4">
            <div class="row">  <!-- Non utilisation des radios mais des checkbox car on peut combiner deux type d'achats, 
        ...
        <div class="container"> <!--Donner nom aux class pr PHP-->
            <div class="row">
